...
from ezwgd.utils.parse import codeml_pairwise
...
_MODEL_LITERAL = Literal['one-ratio', 'free-ratios', 'more-per-branch', 'poisson', 'proportional', 'Empirical', 'Empirical+F', 'FromCodon0', 'FromCodon1', 'REVaa0', 'REVaa']
_MODEL_MAP = {'one-ratio': 0, 'free-ratios': 1, 'more-per-branch': 2,
              ...
              'REVaa0': 8, 'REVaa': 9}
_NSSITES_LITERAL = Literal['one-omega', 'netural', 'selection', 'discrete', 'freqs', 'gamma', '2gamma', 'beta', 'beta-omega', 'beta-gamma', 'beta-gamma1', 'beta-normal>1', '0-2normal>1', '3normal>0']
