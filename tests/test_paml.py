...
def test_config_default_setting():
    ...
    # `ConfigCODEML` and `CODEML` should have 30 parameters (exclude `treefile`, which is optionable conditionally)
    ...
    for param in param_list:
        print(param, param_default_semantic[param], param_default_numeric[param])
